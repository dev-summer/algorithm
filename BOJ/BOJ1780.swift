...
//        return
//    } else {
//        let slice = arr.count / 3
//
//        recur(Array(arr[0..<slice].map { Array($0[0..<slice]) }))
//        recur(Array(arr[0..<slice].map { Array($0[slice..<slice * 2]) }))
//        recur(Array(arr[0..<slice].map { Array($0[slice * 2..<arr.count]) }))
//        recur(Array(arr[slice..<slice * 2].map { Array($0[0..<slice]) }))
//        recur(Array(arr[slice..<slice * 2].map { Array($0[slice..<slice * 2]) }))
//        recur(Array(arr[slice..<slice * 2].map { Array($0[slice * 2..<arr.count]) }))
//        recur(Array(arr[slice * 2..<arr.count].map { Array($0[0..<slice])} ))
//        recur(Array(arr[slice * 2..<arr.count].map { Array($0[slice..<slice * 2]) }))
//        recur(Array(arr[slice * 2..<arr.count].map { Array($0[slice * 2..<arr.count]) }))
//    }
//}
//recur(map)
